 ...
 * colour, levels and curve control from PHOTO-007) into real pixel data
 * (PHOTO-006) — a save has to commit an actual image, not a filter/LUT that
 * only exists as long as the preview canvas is on screen. Matches the
 * source's own format: PNG

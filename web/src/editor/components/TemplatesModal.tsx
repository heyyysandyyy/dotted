...
function SavedCard({
  ...
  return (
    <div className="group relative flex flex-col items-center gap-2 rounded-lg border border-neutral-200 p-3 text-center transition hover:border-neutral-900 hover:bg-neutral-50">
      <button onClick={onPick} className="flex flex-col items-center gap-2">
        ...
        />
        <div className="text-sm font-medium text-neutral-800">{meta.name}</div>
        <div className="text-xs text-neutral-500">
      ...
      <button
        ...
        className="absolute right-2 top-2 rounded p-1 text-neutral-400 opacity-0 transition hover:bg-red-50 hover:text-red-600 group-hover:opacity-100"
      >
        <Trash2 size={14} />
      </button>
    </div>

...
- [ ] PHOTO-007 Tonal and color adjustment tools (large — levels, curves, exposure, highlights/shadows, saturation/vibrance, hue shift, white balance, color balance, black & white conversion, invert; two phases shipped, both on the PHOTO-004 slider+preview+reset pattern — tone controls phase 1 (exposure, highlights, shadows) and the color-controls phase (saturation/vibrance, hue shift, white balance, color balance, black & white, invert); still to come: levels/curves — histogram + point-based UI, a different shape of work)

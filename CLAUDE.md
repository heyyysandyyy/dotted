...
- [x] UX-028 Shape stroke options — style (solid/dashed/spaced/dotted) and alignment (center/inside) controls in the Properties Panel's existing Style section, alongside the already-shipped stroke color/width
